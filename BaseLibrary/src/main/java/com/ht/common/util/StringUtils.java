...
public class StringUtils {
	...
	private static Pattern MOBILE_PATTERN = Pattern.compile("^((13[0-9])|(14[5,7])|(15[0-3,5-9])|(16[6])|(17[0,1,3,5-8])|(18[0-9])|(19[8,9]))\\d{8}$");

	private static Pattern INTEGET_PATTERN = Pattern.compile("^[-\\+]?[\\d]*$");
	...
	public static boolean isInteger(String str) {
		return INTEGET_PATTERN.matcher(str).matches();
	}
	 ...
	 * 判断原字符串里面是否包含新的字符
	 * */
	public static   boolean isSameString(String str,String newStr) {
		String[] strarray = str.split("&");
		return Arrays.asList(strarray).contains(newStr);
	}
     ...
     * @param value
     *            8-16位
     * @return 密码至少包含字母、符号或数字中的两项且长度超过8位
     */
