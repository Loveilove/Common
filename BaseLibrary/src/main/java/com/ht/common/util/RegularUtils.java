...
public class RegularUtils {
     ...
     * 正则：身份证号码18位及15位
     */
    final static String REGEX_IDCARD = "(^[1-9]\\d{5}(18|19|([23]\\d))\\d{2}((0[1-9])|(10|11|12))(([0-2][1-9])|10|20|30|31)\\d{3}[0-9Xx]$|^[1-9]\\d{5}\\d{2}((0[1-9])|(10|11|12))(([0-2][1-9])|10|20|30|31)\\d{3}$)";
     ...
     * 小数
     */
    public static final String DIGIT= "(^[\\-0-9][0-9]*(.[0-9]+)?)$";

//    final String mobileNumberReg = "^(13[0-9]|14[5|7]|15[0|1|2|3|5|6|7|8|9]|18[0|1|2|3|5|6|7|8|9])\\d{8}$";
//    final String phoneReg = "^\\d{3}\\d{8}|\\d{4}\\d{7}";
}