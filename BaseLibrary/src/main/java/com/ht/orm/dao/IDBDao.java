...
public interface IDBDao<T> {
	 ...
	 * @return
	 */
	List<T> query(String where, Page page);
	 ...
	 * @return
	 */
	List<T> queryOrder(String orderBy, Page page);
	 ...
	 * @return
	 */
	List<T> query(String selection, String[] selectionArgs, Page page);
	 ...
	 * @return
	 */
	List<T> query(String selection, String[] selectionArgs, String groupBy, String having, String orderBy, Page page);
